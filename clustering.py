...
for k in range(2, 21):
     ...
     silhouette_coefficient_array.append(silhouette_coefficient)
     if silhouette_coefficient > highest:
          max_k = k
          highest = silhouette_coefficient

#plot the value of the silhouette_coefficient for each k value of kmeans so that we can see the best k
#--> add your Python code here
plt.plot(k_array, silhouette_coefficient_array)
plt.xlabel('k')
